    ...
    <div class="resetpassword">
        ...
        if (isset($_GET["mailsent"])) {
            if ($_GET["mailsent"] == "success") {
                echo '<p class="mailsent">Check your email!</p>';
            } else if ($_GET['mailsent'] == "failed") {
                echo '<p class="resetrequesterror">The request could not be sent. Please try again in a few minutes.</p>';
            }
        } elseif (isset($_GET["error"])) {
            if ($_GET["error"] == "emaildoesntexist") {
                echo '<p class="resetrequesterror">The email you provided does not exist in DB! Please provide the right email.</p>';
            }
        }
